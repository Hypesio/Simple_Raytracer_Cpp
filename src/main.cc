...
int main()
{
    ...
    auto mainLight = std::make_shared<PointLight>(Point3(0.3f, 1.5f, 2.5f), 1, 8);
    ...
    objects.push_back(std::make_shared<Sphere>(Point3(0.75f, 0.75f, 4.0f), 0.7f, std::make_shared<UniformTexture>(Color(255, 0, 0), 0.3f, 0.2f)));
    objects.push_back(std::make_shared<Sphere>(Point3(-1.8f, 0.0f, 3.0f), 0.5f, std::make_shared<UniformTexture>(Color(255, 255, 0), 0.3f, 0.4f)));
    objects.push_back(std::make_shared<Sphere>(Point3(-1.6f, 1.5f, 4.0f), 0.4f, std::make_shared<UniformTexture>(Color(255, 180, 0), 0.5f, 0.5f)));
